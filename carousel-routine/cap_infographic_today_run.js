...
(async () => {
  ...
  const server = http.createServer((req, res) => {
    ...
    const htmlPath = '/Users/apple/Documents/{{BRAND_SHORT_NAME}}-data/daily-linkedin-posts-pipeline/linkedin-infographic.html';
  ...
  const outputPath = `/Users/apple/Documents/{{BRAND_SHORT_NAME}}-data/daily-linkedin-posts-pipeline/linkedin-infographic-${d}.png`;
