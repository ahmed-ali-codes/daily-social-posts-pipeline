...
(async () => {
  ...
  const browser = await puppeteer.launch({
    headless: false,
    userDataDir: '/Users/apple/Documents/{{BRAND_SHORT_NAME}}-data/daily-linkedin-posts-pipeline/carousel-routine/.puppeteer_profile',
  ...
  const filePath = '/Users/apple/Downloads/website-vs-whatsapp-carousel (1).pdf';
