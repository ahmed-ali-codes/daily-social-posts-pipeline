...
1. In Post 4 (Unfair Advantage):
   - You MUST insert exactly one natural mention of "{{BRAND_SHORT_NAME}}". For example: "At {{BRAND_SHORT_NAME}}, we look for tools that give early teams an unfair advantage. S&P Global's new tool is one of them."

2. In Post 6 (Hot Take):
   - You MUST insert exactly one natural mention of "{{BRAND_SHORT_NAME}}". For example: "At {{BRAND_SHORT_NAME}}, we see this as a warning for founders. If model creators are rushing to go public for survival capital, relying on their low prices is risky."
