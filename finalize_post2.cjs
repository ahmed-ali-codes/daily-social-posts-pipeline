...
(async () => {
  try {
    ...
    await page.screenshot({ path: '/Users/apple/Documents/{{BRAND_SHORT_NAME}}-data/daily-linkedin-posts-pipeline/pre_click_schedule.png' });
    ...
    if (clicked) {
      ...
      await page.screenshot({ path: '/Users/apple/Documents/{{BRAND_SHORT_NAME}}-data/daily-linkedin-posts-pipeline/post_click_schedule.png' });
