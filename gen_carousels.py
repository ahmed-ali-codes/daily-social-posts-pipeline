#!/usr/bin/env python3
"""Generate {{BRAND_NAME}} cream-design carousel slides (typography-forward) for both
...
<div class="hright"><div class="fw">{{BRAND_SHORT_NAME_LOWER}} solutions / 2026</div><div class="badge">{num}</div></div></div>
...
def build(slide, accent, kicker):
    ...
    if slide.get("cta"):
        bottom = '<div class="pill">follow @{{BRAND_SHORT_NAME_LOWER}} for daily <em>frameworks.</em></div>'
    else:
...
write_set("carousel-branded", "#D9785B", "{{BRAND_NAME}} / build in public", BRANDED)
write_set("carousel-performance", "#E16259", "{{BRAND_NAME}} / founder story", PERF)
print("done")
