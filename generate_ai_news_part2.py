...
system_prompt = """
You are {{AUTHOR_NAME}}'s AI news content generator. Write the remaining 4 LinkedIn posts (Post 4, Post 5, Post 6, and Post 7) about the week's AI developments.
...
- Include exactly 1 natural mention of "{{BRAND_SHORT_NAME}}" in Post 6 (Hot Take) and 1 in Post 4 (Unfair Advantage). Make it fit naturally.

Here are the news items of the week (June 1-4, 2026) to cover:
- Post 4 (Unfair Advantage): S&P Global's Credit Memo Builder. Explain how analysts can build credit memos in minutes. Include natural {{BRAND_SHORT_NAME}} mention.
...
- Post 6 (Hot Take): Anthropic's confidential S-1 IPO filing. Challenge the optimistic funding narrative; explain it as a cash-out before training cost squeeze. Include natural {{BRAND_SHORT_NAME}} mention.
