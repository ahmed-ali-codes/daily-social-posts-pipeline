...
(async () => {
  try {
    ...
    await page.screenshot({ path: '/Users/apple/Documents/{{BRAND_SHORT_NAME}}-data/daily-linkedin-posts-pipeline/slack_downloads/scheduled_modal_scrolled.png' });
    ...
    if (clickedShowMore) {
      ...
      await page.screenshot({ path: '/Users/apple/Documents/{{BRAND_SHORT_NAME}}-data/daily-linkedin-posts-pipeline/slack_downloads/scheduled_modal_scrolled_more.png' });
    }
