...
(async () => {
  ...
  try {
    ...
    await page.screenshot({ path: '/Users/apple/Documents/{{BRAND_SHORT_NAME}}-data/daily-linkedin-posts-pipeline/slack_downloads/pre_save_anthropic.png' });
    ...
    await page.screenshot({ path: '/Users/apple/Documents/{{BRAND_SHORT_NAME}}-data/daily-linkedin-posts-pipeline/slack_downloads/post_save_anthropic.png' });
