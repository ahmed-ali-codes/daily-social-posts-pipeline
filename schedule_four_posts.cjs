...
Follow @{{BRAND_SHORT_NAME_LOWER}} for daily frameworks.`,
      assetPath: '/Users/apple/Documents/{{BRAND_SHORT_NAME}}-data/daily-linkedin-posts-pipeline/slack_downloads/linkedin-carousel-2026-06-11.pdf',
...
Follow @{{BRAND_SHORT_NAME_LOWER}} for more data drops.`,
      assetPath: '/Users/apple/Documents/{{BRAND_SHORT_NAME}}-data/daily-linkedin-posts-pipeline/slack_downloads/linkedin-infographic.png'
    },
    {
      id: 3,
      type: 'regular',
...
Follow @{{BRAND_SHORT_NAME_LOWER}} for more insights.`
  ...
  try {
    ...
    for (const post of posts) {
      ...
      console.log(`==========================================`);
      const prefix = `/Users/apple/Documents/{{BRAND_SHORT_NAME}}-data/daily-linkedin-posts-pipeline/slack_downloads/post_${post.type}`;
    ...
    try {
      ...
      if (dirs.length > 0) {
        ...
        if (errPage) {
          await errPage.screenshot({ path: '/Users/apple/3d website/error_screenshot.png' });
          console.log("Saved error screenshot to /Users/apple/3d website/error_screenshot.png");
        }
      }
    } catch (screenErr) {
