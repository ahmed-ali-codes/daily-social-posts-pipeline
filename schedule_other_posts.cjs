...
(async () => {
  ...
  try {
    ...
    for (const post of posts) {
      ...
      console.log(`==========================================`);
      const prefix = `/Users/apple/Documents/{{BRAND_SHORT_NAME}}-data/daily-linkedin-posts-pipeline/slack_downloads/post_other_${post.id}`;
