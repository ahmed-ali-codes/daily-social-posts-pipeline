...
(async () => {
  const caption = fs.readFileSync('/Users/apple/Documents/{{BRAND_SHORT_NAME}}-data/daily-linkedin-posts-pipeline/post3_caption.txt', 'utf8').trim();
  const date = '06/09/2026';
  const time = '8:30 AM';
  const prefix = '/Users/apple/Documents/{{BRAND_SHORT_NAME}}-data/daily-linkedin-posts-pipeline/slack_downloads/post_regular';
