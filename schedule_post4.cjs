...
(async () => {
  const caption = fs.readFileSync('/Users/apple/Documents/{{BRAND_SHORT_NAME}}-data/daily-linkedin-posts-pipeline/post4_caption.txt', 'utf8').trim();
  ...
  const prefix = '/Users/apple/Documents/{{BRAND_SHORT_NAME}}-data/daily-linkedin-posts-pipeline/slack_downloads/post_poll';
